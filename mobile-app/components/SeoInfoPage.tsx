...
const styles = StyleSheet.create({
  ...
  topBar: { minHeight: 64, borderWidth: 1, borderColor: '#2A1B55', backgroundColor: 'rgba(8,12,26,0.82)', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 14 },
  ...
  mainGrid: { flexDirection: 'row', gap: 18, alignItems: 'stretch', justifyContent: 'center' },
  ...
  pagePanel: { flex: 1, maxWidth: 860, borderWidth: 1, borderColor: '#263653', backgroundColor: 'rgba(7,12,25,0.94)', borderRadius: 24, padding: 20, gap: 18, overflow: 'hidden' },
  ...
  section: { borderWidth: 1, borderColor: '#202B46', backgroundColor: '#0D1728', borderRadius: 16, padding: 16, gap: 8 },
